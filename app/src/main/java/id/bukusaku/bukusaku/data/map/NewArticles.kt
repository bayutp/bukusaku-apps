...
data class NewArticles(
    ...
    companion object {
        fun from(data: NewArticleEntity) = NewArticles(
            data.id,
            data.title,
            data.category,
            data.imageUrl
        ...
        fun from(data: ArticlesModel) = NewArticles(
            data.id,
            data.title,
            data.category,
            data.imageUrl
...
data class Articles(
    ...
    companion object {
        fun from(data: ArticlesEntity) = Articles(
            data.id,
            data.title,
            data.category,
            data.imageUrl,
        ...
        fun from(data: ArticleDetail) = Articles(
            data.id,
            data.title,
            data.categories,
            data.imageUrl,
